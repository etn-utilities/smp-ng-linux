...
static int imx8mm_clocks_probe(struct platform_device *pdev)
{
	...
	clks[IMX8MM_CLK_RDC_ROOT] = imx_clk_gate4("rdc_root_clk", "ipg_root", base + 0x4310, 0);
	clks[IMX8MM_CLK_SEMA42_1_ROOT] = imx_clk_gate4("sema42_1_root_clk", "ipg_root", base + 0x43D0, 0);
	clks[IMX8MM_CLK_SEMA42_2_ROOT] = imx_clk_gate4("sema42_2_root_clk", "ipg_root", base + 0x43E0, 0);
